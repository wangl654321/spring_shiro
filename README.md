...
<p>
git地址：<a href="https://git.oschina.net/manage/spring-shiro-training.git" target="_blank">https://git.oschina.net/manage/spring-shiro-training.git</a>&nbsp;
</p>
<p>
...
<p>
访问路径是http://localhost:8080/shiro
admin test 管理员权限
test test 查看权限
